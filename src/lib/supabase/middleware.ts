...
export async function updateSession(request: NextRequest) {
  ...
  // Do not run code between createServerClient and getUser(). A
  // simple mistake can make it very hard to debug issues with deep-link auth
  // or token refreshing.
  ...
  // 4. If you do not caught any error, then the user is authenticated.
